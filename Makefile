...
TARFILE = ../dvir-deposit-$(shell date +'%Y-%m-%d').tar.gz
...
docker:
	sudo docker run -v $(shell pwd):/home/work/ -w /home/work --rm pmur002/dvir make dvir.html

web:
	make docker
	cp -r ../dvir-intro-report/* ~/Web/Reports/dvir/intro/
